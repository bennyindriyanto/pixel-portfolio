  ...
  return (
    <section id="projects" className="container px-4 mx-auto">
      <div className="max-w-5xl mx-auto">
        ...
        <h3 className="text-3xl font-bold mb-10">Featured Work</h3>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            <Card key={index} className="glass h-full flex flex-col hover:shadow-blue-400/10 transition-all hover:-translate-y-1 border-white/5">
              ...
              <CardContent className="flex-grow">
                <CardDescription className="text-base text-white/70 mb-4">{project.description}</CardDescription>
